...
export function AdminBillingPageSkeleton() {
  return (
    <div
      ...
      data-testid="admin-billing-page-skeleton"
    >
        ...
        <section className="w-full max-w-[1750px] mx-auto px-4 sm:px-8 lg:px-16">
          ...
          <div className="mt-6 grid grid-cols-1 gap-5 xl:grid-cols-2">
            {Array.from({ length: 2 }).map((_, index) => (
              <CardGradient key={`billing-top-${index}`} className="rounded-[22px] p-5 sm:p-6">
            ...
            <div className="xl:col-span-2">
              <CardGradient className="rounded-[22px] p-5 sm:p-6">
                ...
                <Skeleton className="mt-6 h-[360px] w-full rounded-[18px] bg-foreground/5 dark:bg-white/5" />
