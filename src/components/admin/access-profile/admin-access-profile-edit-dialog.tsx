...
export function AdminAccessProfileEditDialog({
  profile,
  open,
  onOpenChange,
  onSave,
  ...
  onSave: (profile: AdminAccessProfile) => void;
}) {
              ...
              <div className="px-6 py-6 sm:px-8 sm:py-7">
                <div className="flex items-start justify-between gap-4">
                  <div>
                    ...
                    <Dialog.Description className="mt-1 text-[13px] leading-5 text-foreground/60 dark:text-white/50">
                      Atualize o nome e as permissões disponíveis para este perfil
                    </Dialog.Description>
                  </div>
                  <Dialog.Close
                    aria-label="Fechar modal de edição do perfil"
                ...
                <div className="mt-8">
                  <AdminUsersFormSection
                    ...
                    description="Configure o perfil de acesso e as funcionalidades disponíveis"
                  >
                ...
                <div className="mt-10 flex items-center justify-center gap-6">
                  ...
                  <ButtonBorder
                    type="button"
                    className="h-10 min-w-[164px] px-6 text-[13px]"
